((exports) => {
  ...
  const $attendeeType = $('[name="course_registration_invite[existing_user]"');
  ...
  createFieldDependentInputs({
    ...
    enablingCondition: () => {
      return $("#course_registration_invite_existing_user_false").is(":checked")
    }
  });
  ...
  createFieldDependentInputs({
    ...
    dependentInputSelector: "input",
    enablingCondition: () => {
      return $("#course_registration_invite_existing_user_true").is(":checked")
    }
  });
})(window);
