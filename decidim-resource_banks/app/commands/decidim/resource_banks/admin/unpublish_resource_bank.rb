...
module Decidim
  module ResourceBanks
    module Admin
      # A command that sets a resource_bank as unpublished.
      class UnpublishResourceBank < Rectify::Command
        ...
        def call
          ...
          Decidim.traceability.perform_action!("unpublish", resource_bank, current_user) do
            resource_bank.unpublish!
          end
