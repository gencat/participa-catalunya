...
ActiveRecord::Schema.define(version: 20_201_026_084_454) do
  ...
  create_table "decidim_consultations_votes", force: :cascade do |t|
    ...
    t.index %w(decidim_consultation_question_id decidim_author_id decidim_user_group_id), name: "index_question_votes_author_unique", unique: true
  ...
  create_table "decidim_courses", force: :cascade do |t|
    ...
    t.datetime "published_at"
    t.boolean "private_space", default: false
    t.index %w(decidim_organization_id slug), name: "index_unique_course_slug_and_organization", unique: true
  ...
  create_table "decidim_initiatives_votes", force: :cascade do |t|
    ...
    t.index %w(decidim_initiative_id decidim_author_id decidim_user_group_id), name: "decidim_initiatives_voutes_author_uniqueness_index", unique: true
